...
export default function makeMakeFormStore(validatorFunctions, valueTypes) {
    function makeFormStore(makeInputsOptions) {
        ...
        function toggleIsCheckableInPlace(_a) {
            var inputId = _a.inputId, draftState = _a.draftState, newIsCheckable = _a.newIsCheckable;
            var currentTime = Date.now();
            var draftInputState = getDraftInputState(draftState, inputId);
            var previousIsCheckable = draftInputState.isCheckable;
        ...
        return create(function (set, get) {
            ...
            return {
                ...
                localErrorInputIds: [],
                serverErrorInputIds: [],
                checkableInputIds: __spreadArrays(inputIds),
                focusedInputId: "",
                ...
                toggleIsCheckable: function (_a) {
                    ...
                    _setImmutable(function (draftState) {
                        toggleIsCheckableInPlace({ draftState: draftState, inputId: inputId, newIsCheckable: newIsCheckable });
                    });
                },
                refreshForm: function (initialValuesByInputId, isCheckabByInputId, serverErrorsByInputId) {
                    ...
                    _setImmutable(function (draftState) {
                        ...
                        for (var _i = 0, _f = baseState.allInputIds; _i < _f.length; _i++) {
                            ...
                            toggleIsCheckableInPlace({ inputId: inputId, newIsCheckable: newIsCheckable, draftState: draftState });
                            objectAssign(draftInputState, {
